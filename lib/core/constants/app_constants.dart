...
class AppConstants {
  ...
  static const int maxAudioScanBytes =
      1024 * 1024; // 1MB prefix untuk LP3/FLAC/OGG
  static const int maxPdfExtractionSizeBytes = 10 * 1024 * 1024; // 10MB
  static const int maxRemoverFileSizeBytes = 50 * 1024 * 1024; // 50MB
  static const int maxZipEntryDecompressBytes =
      64 * 1024 * 1024; // 64MB per entry
